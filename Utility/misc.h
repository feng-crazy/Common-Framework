/*****************************************************************************
	功能描述:共用的一些函数方法，可以在其他类中直接使用这些方法
	相当于定义了一组全局函数.
...
#define TODO() printf("%s(line %d): %s not implemented yet!\n", \
		__FILE__, __LINE__, __PRETTY_FUNCTION__)
#define SWITCH(str) string __string__ = str;
#define CASE(str) while(__string__ == str) {
#define BREAK break; }

//ref_chenli 将此处的定义放到SysStatus中。
//#define FREEZEN_SEC 120 // 冻结回顾时间秒数
...
void split_string(const string src, vector<string>& dest, const string separator);
